...
import 'package:bank_app/Model/bankslist.dart';
...
class _TransferState extends State<Transfer> {
  ...
  String bankDropdown = 'Select';
  String customerChosen = 'Select';
  List bankslist = newList();
  List namesCustomers = [
    'Select',
  ];
  String beneficiary = '';
                    ...
                    child: Card(
                      ...
                      child: Column(children: [
                            ...
                            DropdownButton(
                                ...
                                items: [
                                  ...
                                  DropdownMenuItem(
                                      ...
                                      child: Text(
                                          '${data[0].accountNo}- -Balance:${data[0].balance}')),
                                ],
                        ...
                        Visibility(
                          ...
                          child: Text('Beneficiary: $beneficiary',
                              style: TextStyle(
                                  color: colorB,
                                  fontSize: 15,
                                  fontWeight: FontWeight.w200)),
          ...
          if (data[0].balance > int.parse(amount.text)) {
              ...
              for (var i = 0; i < customers.length; i++) {
                if (customers[i].accountNo == customerChosen) {
                  setState(() {
                    ...
                    customers[i].transactions.add(Transaction(
                          type: 'Credit',
            ...
            setState(() {
              ...
              data[0].transactions.add(Transaction(
                    ...
                    amount: int.parse(amount.text),
                    date: 
                        DateFormat.yMd().add_jm().format(DateTime.parse(DateTime.now().toString())),
